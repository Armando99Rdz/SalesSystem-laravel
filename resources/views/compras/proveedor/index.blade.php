...
@section('contenido')
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-auto">
                ...
                <h2 class="page-title">
                    Proveedores
                    <a href="proveedor/create" class="btn btn-outline-primary" style="padding:4px;font-size:14px;">
                        Nuevo
                    </a>
                </h2>
            </div>
    ...
    @include('compras.proveedor.card-header-table')
    ...
    <!-- tabla de categorias -->
            ...
            <table class="table table-vcenter card-table">
                ...
                @foreach($personas as $p)
                    ...
                    <tr>
                        ...
                        <td class="text-bold">
                            <a href="{{ URL::action( 'ProveedorController@edit', $p -> idpersona ) }}" class="m-2">Editar</a>
                            <a href="#" class="link-danger m-2" data-toggle="modal" data-target="#confirm-delete-{{$p->idpersona}}">Eliminar</a>
                        </td>
                    </tr>

                    <!-- modal de confirmacion para eliminar -->
                    @include('compras.proveedor.modals.delete')
        ...
        @include('compras.proveedor.card-footer-table')
    </div>
